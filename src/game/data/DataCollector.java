...
public class DataCollector {
    ...
    public static synchronized void addDeltaTeam(int depth, int team, String algo) {
    ...
    public static synchronized void addDeltaSize(int depth, int size, String algo) {
